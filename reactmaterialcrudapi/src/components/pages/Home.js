...
const Home = () => {
 ...
 function onTextFieldChange(e) {
  setStudent({
   ...student,
   [e.target.name]: e.target.value         //name(stuname,email) = value(entered by user)
  })
 }

//  function onNameChange(e){                        //for single change
//     setStudent({'stuname':e.target.value})     //name attribute value = entred valueby user
//  }

 async function onFormSubmit(e) {                        //we will not use useeffect whn we send the data
  e.preventDefault()
  try {
